            ...
            <asp:Repeater ID="TaskRepeater" runat="server" OnItemCommand="TaskRepeater_ItemCommand" >
                <ItemTemplate>                    
                    <div>
                        ...
                        &nbsp;
                        <asp:Button ID="getSubTasks" Text="View Subtasks" runat="server" CommandName="getSubTasks" CommandArgument='<%# Eval("TaskName") %>' />
                        &nbsp;
                        <asp:Button id="getAssignedUsers" Text="View assigned users" runat="server" CommandName="getAssignedUsers" CommandArgument='<%# Eval("TaskName") %>' />
                    </div>
                </ItemTemplate>
            </asp:Repeater>
        </div>
